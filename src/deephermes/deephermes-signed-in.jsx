...
const API_KEY = "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";
const BOT_NAME = "deephermes";
        ...
        {showChatContainer && (
          <div className="flex-column chat-container ms-2 vw-100" style={{ height: "89vh" }}>
            <div className="chat-header">
              <h2>Nous: DeepHermes 3 Mistral 24B Preview</h2>
            </div>
