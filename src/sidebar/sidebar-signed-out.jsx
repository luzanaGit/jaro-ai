  ...
  return (
    <div className="sidebar bg-dark collapsed" id="sidebar">
      <nav className="nav flex-column">
        <Link className="nav-link" to="/deephermes-signed-out">
          <span className="icon">
            <i className="bi bi-graph-up-arrow"></i>
          </span>
          <span className="description">Nous: DeepHermes</span>
        </Link>
        <Link className="nav-link" to="/devstral-signed-out">
          <span className="icon">
            <i className="bi bi-plus-lg"></i>
          </span>
          <span className="description">Mistral: Devstral Small</span>
        </Link>
        <Link className="nav-link" to="/gemma-signed-out">
          <span className="icon">
            <i className="bi bi-envelope"></i>
          </span>
          <span className="description">Google: Gemma</span>
        </Link>
        <Link className="nav-link" to="/llama-signed-out">
          <span className="icon">
            <i className="bi bi-person"></i>
          </span>
          <span className="description">Meta: Llama</span>
        </Link>
        <Link className="nav-link" to="/qwen-signed-out">
          <span className="icon">
